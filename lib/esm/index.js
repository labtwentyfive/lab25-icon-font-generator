    ...
    compile() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield writeFile(join(this.paths.dist.font, `${fileName}-webfont.woff2`), result.woff2);
                yield writeFile(join(this.paths.dist.font, `${fileName}-webfont.eot`), result.eot);
                yield writeFile(join(this.paths.dist.font, `${fileName}-webfont.woff`), result.woff);
                yield writeFile(join(this.paths.dist.font, `${fileName}-webfont.ttf`), result.ttf);
