...
class default_1 {
    ...
    compile() {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.writeFile((0, path_1.join)(this.paths.dist.font, `${fileName}-webfont.woff2`), result.woff2);
                yield this.writeFile((0, path_1.join)(this.paths.dist.font, `${fileName}-webfont.eot`), result.eot);
                yield this.writeFile((0, path_1.join)(this.paths.dist.font, `${fileName}-webfont.woff`), result.woff);
                yield this.writeFile((0, path_1.join)(this.paths.dist.font, `${fileName}-webfont.ttf`), result.ttf);
    ...
    writeFile(path, contents) {
        try {
            ...
            (0, promises_1.writeFile)(path, contents);
        }
        catch (err) {
            throw err;
        }
